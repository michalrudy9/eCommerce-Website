		...
		while( !$parser -> isEnd() )
		{
			...
			else if( $peek == ':' )
			{
				...
				else if( Gen::StrStartsWith( $identifierLwr, 'host' ) )
				{
					...
					{
						$parser -> traceException( new Sabberworm\CSS\Parsing\SourceException( Sabberworm\CSS\Settings::ParseErrLow, 'Selector of \'' . $identifierLwr . '\' should not be multiple.', $iPos ) );
